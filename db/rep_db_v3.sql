...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `paquete_change_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `paquete_change_status`(
	IN _id varchar(50),
    IN _date varchar(200)
)
BEGIN
	DECLARE _paquete INT;
	SELECT id_paquete INTO _paquete FROM paquete WHERE id_paquete = _id;
    IF(_paquete IS NULL) THEN
		SELECT 0 AS _message;
    ELSE
		SELECT 1 AS _message;
...
-- Dump completed on 2021-05-10 21:45:22
